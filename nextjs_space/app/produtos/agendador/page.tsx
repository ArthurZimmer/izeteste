  ...
  const products = [
    {
      ...
      icon: Briefcase,
      description: 'Agende reuniões automaticamente considerando a disponibilidade de todos os participantes.',
      benefits: [
      ...
      ideal: 'Consultores, coaches e equipes comerciais',
    },
    {
      name: 'Agendador para Salões',
      icon: Scissors,
      description: 'Sistema completo de agendamento para salões de beleza, barbearias e estética.',
      benefits: [
      ...
      ideal: 'Salões de beleza, barbearias e clínicas de estética',
      featured: true,
    },
    {
      name: 'Agendador Médico',
      icon: Stethoscope,
      description: 'Solução especializada para consultórios e clínicas médicas com gestão completa.',
      benefits: [
        'Agendamento online 24h',
        'Confirmação de presena por WhatsApp',
        'Gestão de convênios',
        'Prontuário integrado',
        'Lista de espera automática',
        'Telemedicina integrada',
      ],
      ideal: 'Consultórios médicos, clínicas e dentistas',
    },
  ];
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-bold">
                Agendador de <span className="gradient-text">Eventos</span>
              </h1>
            </div>
          </div>
          <p className="text-gray-600 text-lg max-w-3xl">
            Elimine a troca interminável de mensagens para marcar horários. 
            Deixe a IA gerenciar sua agenda enquanto você foca no que importa.
          </p>
        </motion.div>
              ...
              <div className="p-8">
                <div className="flex flex-col md:flex-row md:items-start gap-6">
                  <div className="w-14 h-14 rounded-xl bg-blue-100 flex items-center justify-center flex-shrink-0">
                    {product?.icon && <product.icon className="w-7 h-7 text-blue-600" />}
                  </div>
