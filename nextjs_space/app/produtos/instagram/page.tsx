...
export default function InstagramPage() {
  ...
  const products = [
    {
      name: 'Respondedor de DMs',
      icon: Send,
      description: 'Responda mensagens diretas automaticamente. Qualifique seguidores e converta em clientes.',
      benefits: [
        'Respostas instantâneas 24/7',
        'Menu de opções interativo',
        'Envio de catálogos e links',
        'Encaminhamento para WhatsApp',
        'Detecção de interesse de compra',
      ],
      ideal: 'Lojas e criadores de conteúdo',
    },
    {
      name: 'Respondedor de Comentários',
      icon: MessageSquare,
      description: 'Engaje automaticamente com comentários nas suas publicações. Aumente o alcance orgânico.',
      benefits: [
        'Respostas personalizadas por contexto',
        'Agradecimentos automáticos',
        'Detecção de comentários negativos',
        'Convite para DM ou link na bio',
        'Moderação de spam',
        'Aumento de engajamento',
      ],
      ideal: 'Influenciadores e marcas',
      featured: true,
    },
    {
      name: 'Engajador de Stories',
      icon: Image,
      description: 'Interaja automaticamente com reações e respostas de stories. Maximize o engajamento.',
      benefits: [
        'Resposta a reações de stories',
        'Envio de links e ofertas',
        'Criação de listas de broadcast',
        'Lembretes de conteúdo',
        'Análise de engajamento',
        'Automação de enquetes',
      ],
      ideal: 'Marcas e criadores de conteúdo',
    },
  ];
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-bold">
                Respondedor de <span className="gradient-text">Instagram</span>
              </h1>
            </div>
          </div>
          <p className="text-gray-600 text-lg max-w-3xl">
            Transforme seguidores em clientes. A IA responde DMs, comentários e interações 
            de stories para aumentar seu engajamento e vendas.
          </p>
        </motion.div>
              ...
              <div className="p-8">
                <div className="flex flex-col md:flex-row md:items-start gap-6">
                  <div className="w-14 h-14 rounded-xl bg-pink-100 flex items-center justify-center flex-shrink-0">
                    {product?.icon && <product.icon className="w-7 h-7 text-pink-600" />}
                  </div>
